...
public class FourthQuarter extends AbstractAreaComplex {
    ...
    public FourthQuarter(List<String> path) {
        this(0, 0, path);
    }

    public FourthQuarter(float x, float y) {
        this(x, y, new ArrayList<>(List.of()));
    }

    public FourthQuarter(float x, float y, List<String> path) {
        ...
        area = new PlaneArea(true, updatePath(path, FourthQuarter.class.getSimpleName()));
