package ru.ns.lab.service.areaLegacy.complex.quarter;
...
public class SecondQuarter extends AbstractAreaComplex {
    ...
    public SecondQuarter(List<String> path) {
        this(0, 0, path);
    }

    public SecondQuarter(float x, float y) {
        this(x, y, new ArrayList<>(List.of()));
    }

    public SecondQuarter(float x, float y, List<String> path) {
        ...
        area = new PlaneArea(true, updatePath(path, SecondQuarter.class.getSimpleName()));
