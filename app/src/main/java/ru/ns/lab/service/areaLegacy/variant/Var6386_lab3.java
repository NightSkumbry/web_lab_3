package ru.ns.lab.service.areaLegacy.variant;
...
import ru.ns.lab.service.areaLegacy.base.LineSegment;
import ru.ns.lab.service.areaLegacy.base.PlaneArea;
import ru.ns.lab.service.areaLegacy.complex.QuarterCircle;
import ru.ns.lab.service.areaLegacy.complex.Rectangle;
import ru.ns.lab.service.areaLegacy.complex.Triangle;

public class Var6386_lab3 extends AbstractAreaComplex {
    ...
    public Var6386_lab3() {
        rectangle = new Rectangle(0, 0, -0.5f, -1, new ArrayList<>(List.of("6386 rectangle")));
        triangle = new Triangle(0, 0, 0, 1, -0.5f, 0, new ArrayList<>(List.of("6386 triangle")));
        quarterCircle = new QuarterCircle(0, 0, 0.5f, 1, new ArrayList<>(List.of("6386 quarterCircle")));
        connector1 = new LineSegment(0, 0, 0, 0.5f, new ArrayList<>(List.of("6386 connector triangle-quarterCircle")));
        antiConnector1 = new LineSegment(0, 0, 0, 0.5f, new ArrayList<>(List.of("6386 connector triangle-quarterCircle")));
        connector2 = new LineSegment(0, 0, -0.5f, 0, new ArrayList<>(List.of("6386 connector rectangle-triangle")));
        antiConnector2 = new LineSegment(0, 0, -0.5f, 0, new ArrayList<>(List.of("6386 connector rectangle-triangle")));
        area = new PlaneArea(false, new ArrayList<>(List.of(Var6386_lab3.class.getSimpleName())));
