...
public class ThirdQuarter extends AbstractAreaComplex {
    ...
    public ThirdQuarter(List<String> path) {
        this(0, 0, path);
    }

    public ThirdQuarter(float x, float y) {
        this(x, y, new ArrayList<>(List.of()));
    }

    public ThirdQuarter(float x, float y, List<String> path) {
        ...
        area = new PlaneArea(true, updatePath(path, ThirdQuarter.class.getSimpleName()));
