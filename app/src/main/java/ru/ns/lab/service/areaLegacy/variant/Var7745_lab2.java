...
public class Var7745_lab2 extends AbstractAreaComplex {
    ...
    public Var7745_lab2() {
        rectangle = new Rectangle(0, 0, -0.5f, -1, new ArrayList<>(List.of("7745 rectangle")));
        triangle = new Triangle(0, 0, 0, -1, 0.5f, 0, new ArrayList<>(List.of("7745 triangle")));
        quarterCircle = new QuarterCircle(0, 0, 0.5f, 1, new ArrayList<>(List.of("7745 quarterCircle")));
        connector1 = new LineSegment(0.5f, 0, 0, 0, new ArrayList<>(List.of("7745 connector triangle-quarterCircle")));
        antiConnector1 = new LineSegment(0.5f, 0, 0, 0, new ArrayList<>(List.of("7745 connector triangle-quarterCircle")));
        connector2 = new LineSegment(0, -1, 0, 0, new ArrayList<>(List.of("7745 connector rectangle-triangle")));
        antiConnector2 = new LineSegment(0, -1, 0, 0, new ArrayList<>(List.of("7745 connector rectangle-triangle")));
        area = new PlaneArea(false, new ArrayList<>(List.of(Var7745_lab2.class.getSimpleName())));
